<x-guest-layout>
    <x-auth-card>
        ...
        <form method="POST" action="{{ route('chavitos-editar', $chavito->id) }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="mt-5">
                ...
                <x-input id="modelo" class="block mt-1 w-full"
                                type="text"
                                name="modelo"
                                autocomplete="current-modelo"
                                placeholder="{{ $chavito->title }}" />
            </div>
